        ...
        <div className="max-w-6xl mx-auto py-10 px-6 ">
          ...
          <div className="max-w-6xl mx-auto py-10 px-6">
            ...
            <ul className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-4">
              <li className="bg-gradient-to-br from-[var(--purple)] to-[var(--pink)] text-white shadow-md rounded-xl p-4">Rapid development of campaign assets for events and announcements</li>
              <li className="bg-gradient-to-br from-[var(--purple)] to-[var(--pink)] text-white shadow-md rounded-xl p-4">Engaging formats to improve employee and stakeholder participation</li>
              <li className="bg-gradient-to-br from-[var(--purple)] to-[var(--pink)] text-white shadow-md rounded-xl p-4">Interactive experiences beyond static communication</li>
              <li className="bg-gradient-to-br from-[var(--purple)] to-[var(--pink)] text-white shadow-md rounded-xl p-4">Experiential creatives for airport and on-ground environments</li>
              <li className="bg-gradient-to-br from-[var(--purple)] to-[var(--pink)] text-white shadow-md rounded-xl p-4">Absolute adherence to global brand guidelines</li>
              <li className="bg-gradient-to-br from-[var(--purple)] to-[var(--pink)] text-white shadow-md rounded-xl p-4">Scalable support across simultaneous initiatives</li>
            </ul>
          </div>
          ...
          <div className="max-w-6xl mx-auto py-10 px-6">
            ...
            <ul className="grid md:grid-cols-4 gap-4">
              <li className="border shadow-md p-4 rounded-xl bg-white">Event campaign identity & collateral systems</li>
              <li className="border shadow-md p-4 rounded-xl bg-white">Internal communication toolkits</li>
              <li className="border shadow-md p-4 rounded-xl bg-white">External marketing assets</li>
              <li className="border shadow-md p-4 rounded-xl bg-white">Awareness & corporate videos</li>
              <li className="border shadow-md p-4 rounded-xl bg-white">Gamified engagement modules</li>
              <li className="border shadow-md p-4 rounded-xl bg-white">Campaign PowerPoint presentations & event communication decks</li>
              <li className="border shadow-md p-4 rounded-xl bg-white">Airport experience creatives & environmental branding</li>
              <li className="border shadow-md p-4 rounded-xl bg-white">Agent Meet event creatives including backdrops & stage design</li>
              <li className="border shadow-md p-4 rounded-xl bg-white">Custom-designed board games for engagement</li>
              <li className="border shadow-md p-4 rounded-xl bg-white">Online interactive games for digital participation</li>
            </ul>
          </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-[var(--purple)] to-[var(--pink)] text-white">
            <div className="max-w-6xl mx-auto py-10 px-6">
              ...
              <ul className="text-3xl font-bold text-center md:flex items-center sm:block justify-center py-20">
                <li className="bg-white px-5 py-4 text-lg rounded-full text-black">Discovery</li>
                <span className="mx-2">→</span>
                <li className="bg-white px-5 py-4 text-lg rounded-full text-black">Concept</li>
                <span className="mx-2">→</span>
                <li className="bg-white px-5 py-4 text-lg rounded-full text-black">Design</li>
                <span className="mx-2">→</span>
                <li className="bg-white px-5 py-4 text-lg rounded-full text-black">Motion</li>
                <span className="mx-2">→</span>
                <li className="bg-white px-5 py-4 text-lg rounded-full text-black">Interactive</li>
                <span className="mx-2">→</span>
                <li className="bg-white px-5 py-4 text-lg rounded-full text-black">Launch</li>&nbsp;
              </ul>
