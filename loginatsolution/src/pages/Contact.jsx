    ...
    <>
      <div className='grid md:grid-cols-2'>
        ...
        <div className="p-5 md:p-20 bg-gray-50">
            <h1 className="lg:text-6xl md:text-4xl text-2xl font-bold">Contact us</h1>
       ...
       <div className="p-5 md:p-20">
            ...
            <div className='mt-10 flex gap-4 items-center'>
                <div className='bg-black text-white rounded-full py-4 px-8'>
                  <h5 className='text-xl font-bold'>Sector 63, Noida</h5>
                </div>
                <div className='bg-gray-300 rounded-full py-4 px-8'>
                  <h5 className='text-xl font-bold'>Kaushambi, Ghaziabad</h5>
                </div>
            </div>
           <div className='mt-10'>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3501.850057169827!2d77.32603309999999!3d28.634255699999994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfb2cae9479c1%3A0x7d42c080fe8221b8!2sLoginAt%20Solutions%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1761916480914!5m2!1sen!2sin" width="100%" height="500"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
           </div>
        </div>
        <div className='p-5 md:p-20 bg-gray-50'>
